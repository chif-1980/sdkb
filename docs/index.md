...
hero:
  name: 善达知枢
  text: 企业知识管理与智能问答平台
  tagline: 从企业知识治理到会议纪要、待办跟进与知识更新，保留来源依据和人工确认。
  image:
    src: /quickdone-logo.webp
    alt: 善达信息
  actions:
    - theme: brand
      text: 善达知枢使用手册
...
features:
  - title: 资料接入
    details: 接入飞书企业知识源，按需执行增量或全量扫描，统一管理来源材料。
  - title: 知识单元审核
    details: 以知识单元为主要审核粒度，结合原文版式和跨文档证据完成局部或整篇处理。
  - title: 证据与治理
    details: 通过来源定位、质量门禁、跨文档关系和运营待办，把 AI 建议变成可核验、可追责的处理依据。
  - title: 正式知识发布
...
本版补充统一 RBAC、飞书部门角色继承、右侧嵌入企业知识助手、用户反馈菜单、会议待办闭环和审计说明；系统架构页新增功能、业务、技术架构及业务流程交互图。查看[系统架构](/guide/architecture)和[版本变更记录](/develop-guides/changelog)。
